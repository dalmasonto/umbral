...
13. [ ] Something else, currently, we register the plugin, the models for that plugin and other resources for the plugin, can we like just register the plugin and the rest get autoregistered?
