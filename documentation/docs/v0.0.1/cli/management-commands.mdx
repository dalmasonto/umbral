...
so the commands see your models and your plugins. The framework-global [`umbral`](./startproject) binary handles
scaffolding (`startproject`, `startplugin`) and nothing else - it can't
