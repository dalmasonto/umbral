...
- [`examples/shop/src/views/public.rs`](https://github.com/dalmas-ogembo/umbra/tree/main/examples/shop/src/views/public.rs) - `submit_contact` is the handler that drives the above.
