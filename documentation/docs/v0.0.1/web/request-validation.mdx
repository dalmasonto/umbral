...
A failing body gets a **400** in the same shape [REST](../rest/errors) already returns for a model write: field errors flattened to the top level, `non_field_errors` alongside, a stable `code`.
