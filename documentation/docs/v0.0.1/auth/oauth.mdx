...
Set `oauth_redirect_base`, `oauth_login_redirect`, the client id/secret, **and a mask keyring** — then just link to `/oauth/{provider}/login` and land on `login_redirect`.
</Tab>
