...
description: Run umbra-realtime behind a load balancer with a Redis pub/sub backplane so targeted sends reach sockets on any instance — and the proven single-instance numbers.
sidebar_position: 6
