...
targets the `author_id` column. This is what [`inspectdb --framework
django`](/docs/v0.0.1/migrations/inspectdb#framework-aware-naming) emits when it
strips the `_id` off a Django foreign-key column.
