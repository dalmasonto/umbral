...
<Callout type="warning">
  ...
  **The workaround today**: resolve the relation in the handler and pass the value into the template context explicitly:
  ...
  See `bugs/gaps2.md` #14 for the design space we're considering (eager-prefetch declaration is the front-runner; mirrors Django's `select_related` / `prefetch_related` pattern).
</Callout>
