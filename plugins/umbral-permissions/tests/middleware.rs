...
use http::Uri;
use umbral_permissions::{PermissionRequired, permission_required, permission_required_html};
...
fn permission_required_factory_constructs_layer() {
    ...
    let _: umbral_permissions::PermissionRequiredLayer = permission_required("blog.publish_post");
    let _: umbral_permissions::PermissionRequiredLayer =
