...
Session storage + cookie helpers for umbral. DB-backed sessions linked to umbral-auth users.
...
```bash
cargo add umbral umbral-sessions
```
...
- Guide: https://dalmasonto.github.io/umbral/docs/v0.0.1/plugins/sessions
- Repository: https://github.com/dalmasonto/umbral
- API reference: https://docs.rs/umbral-sessions
