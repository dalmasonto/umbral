...
pub(crate) fn input_kind(col: &umbral::migrate::Column) -> &'static str {
    ...
    match col.ty {
        ...
        SqlType::Date => "date",
        SqlType::Time => "time",
        SqlType::Timestamptz | SqlType::Timestamp => "datetime-local",
        SqlType::Json => "json",
        ...
        SqlType::Decimal | SqlType::BigDecimal | SqlType::DecimalN(_) => "text",
...
pub(crate) fn sql_type_name(ty: SqlType) -> &'static str {
    match ty {
        ...
        SqlType::Date => "date",
        SqlType::Time => "time",
        SqlType::Timestamptz | SqlType::Timestamp => "datetime",
        SqlType::Uuid => "uuid",
        SqlType::Json => "json",
        SqlType::ForeignKey => "fk",
