...
impl From<umbral::orm::DynError> for AdminError {
    fn from(e: umbral::orm::DynError) -> Self {
        ...
        match e {
            umbral::orm::DynError::Write(w) => Self::Write(w),
            umbral::orm::DynError::Sqlx(s) => Self::Sqlx(s),
        }
    }
}
    ...
    fn into_response(self) -> Response {
        match self {
            ...
            AdminError::Write(e) => {
                ...
                // "umbral::orm::write: <message>" form already; the
