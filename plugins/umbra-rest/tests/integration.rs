//! End-to-end coverage for umbra-rest. Boot the App once with the
...
//! the default block-list (auth_user / session / umbra_migrations
...
async fn excluded_default_tables_return_404() {
    ...
    for table in ["auth_user", "session", "umbra_migrations"] {
