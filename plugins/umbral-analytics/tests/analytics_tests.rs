//! Integration tests for umbral-analytics.
//!
...
/// Real PostHog capture round-trip. Requires `UMBRAL_POSTHOG_API_KEY` and
/// optionally `UMBRAL_POSTHOG_HOST` to be set. Run with:
///
/// ```sh
/// UMBRAL_POSTHOG_API_KEY=phc_xxx cargo test -p umbral-analytics -- --ignored
/// ```
#[tokio::test]
#[ignore]
