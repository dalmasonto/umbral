...
//!
//! Where [`LoginRequiredLayer`](umbra_auth::LoginRequiredLayer) gates a
...
//!
//! ```ignore
//! use umbra_permissions::permission_required;
//!
...
//!
//! ```ignore
//! use umbra_auth::login_required_html;
//! use umbra_permissions::permission_required_html;
//!
    ...
    S::Future: Send + 'static,
{
    ...
    fn call(&mut self, req: axum::extract::Request) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            let user_id = umbra_auth::current_session_user_id(req.headers()).await;
            ...
            // umbra-permissions does not own the user table schema —
