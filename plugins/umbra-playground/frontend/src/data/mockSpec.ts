...
export const mockSpec: OpenAPIV3.Document = {
  openapi: "3.0.3",
  info: {
    title: "Umbra Blog API",
    version: "1.0.0",
    description: "A demo REST API powering the Umbra playground. Built with umbra-rest.",
  },
  servers: [{ url: "/api" }],
  paths: {
    "/posts": {
    ...
    results: [
      {
        ...
        slug: "getting-started-with-umbra",
        content:
          "Umbra is a Django-inspired web framework in Rust. It gives you migrations, CRUD, admin, and REST APIs with compile-time guarantees.",
        author_id: 1,
      ...
      },
      {
        ...
        content:
          "Every feature in Umbra is a plugin. Auth, sessions, admin, tasks, and REST are all plugins. Structurally they are identical to a third-party one.",
        author_id: 2,
