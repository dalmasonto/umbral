...
Auto-generated JSON REST API over umbral models. The DRF in Rust shape.
...
- Guide: https://dalmasonto.github.io/umbral/docs/v0.0.1/plugins/rest
- Repository: https://github.com/dalmasonto/umbral
- API reference: https://docs.rs/umbral-rest
