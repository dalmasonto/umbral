...
## [0.0.12](https://github.com/dalmasonto/umbral/compare/umbral-realtime-v0.0.11...umbral-realtime-v0.0.12) - 2026-08-16

### Other

- *(readmes)* add the umbralrs.dev website link to every crate + plugin
- *(worktree-agent-a9890f0defa728beb)* review_3 dedup batch
- *(realtime)* share SSE/WS handshake authorization
- *(branding)* retire batteries-included for declarative plus modularity motto

## [0.0.11](https://github.com/dalmasonto/umbral/compare/umbral-realtime-v0.0.10...umbral-realtime-v0.0.11) - 2026-08-02

### Added

- *(plugin-contract)* app-wide default authentication seam (gaps4 #42)
- *(realtime)* GroupPolicy is async — gate rooms on DB state (gaps4 #36)

### Other

- *(realtime)* fan-out shares one Arc'd payload + one render (gaps4 #38)
