...
//! - Request carries an `umbral_session` cookie — personalised / logged-in
    ...
    S::Error: Send + 'static,
{
    ...
    fn call(&mut self, req: Request<Body>) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            // request carries an `umbral_session` cookie the response is user-
...
/// Return `true` when the request carries an `umbral_session` cookie.
///
