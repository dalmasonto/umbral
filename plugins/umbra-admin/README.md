...
Auto-generated CRUD admin for umbra models. Drop in `AdminPlugin` and every
...
```sh
cd plugins/umbra-admin/css
npm install
npm run build
```

The output lands at `plugins/umbra-admin/src/assets/admin.css` and is
