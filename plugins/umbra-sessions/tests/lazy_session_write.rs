...
use umbra_sessions::{COOKIE_NAME, Session, SessionToken, SessionsPlugin, read_session, set_data};
...
async fn write_handler_materialises_exactly_one_row_and_sets_cookie() {
    ...
    let cart: Option<i64> = umbra_sessions::get_data(&s, "cart_id").expect("get");
