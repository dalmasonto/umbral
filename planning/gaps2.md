...
65. [x] System/template pagination — SHIPPED (2026-06-20): umbral::pagination::{Paginator, Page} in core (Django core.paginator parity — elided_page_range, start/end_index, serializable PageContext) + querystring_with template global + _pagination.html partial; chose core over a plugin (fundamental ORM utility). eb14237. — archived
