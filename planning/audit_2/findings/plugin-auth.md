...
| 10 | LOW | Doc vs code (fixed) | `auth_routes.rs:117-134` / `users-and-passwords.mdx:224` | Docs claimed the XFF-first-hop scheme "never opens a hole" | Misleads operators into trusting a forgeable throttle key | Doc corrected with a forgery warning (see Docs updated) |
