...
Next-session priority order: P3 #61 remainder (CSV import command, admin bulk-export action, Excel) → P6 phase 5 (Redis broker, playground Realtime tab). P4 is done bar #69 (deferred by design). Everything is committed; nothing half-applied.
