...
- [~] **P3 #56–61** — #56/#57/#59 closed (c37e928); **#58 nested writable serializers SHIPPED** (`ResourceConfig::nested`, FK auto-discovered, compensating rollback — 9ab22e8; true-DB-tx logged as orm_fixes #2). **Still open:** #60 action input/output schemas, #61 CSV/Excel import-export.
