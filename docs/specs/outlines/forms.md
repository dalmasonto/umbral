...
pub struct ContactForm {
    #[umbra(max_length = 200)] pub subject: String,
    #[umbra(widget = Textarea)] pub body: String,
...
- `arch.md §6.3` — the `umbra-admin` description, where the admin's auto CRUD UI is built on top of `ModelForm`.
