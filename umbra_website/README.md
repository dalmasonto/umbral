...
Official Umbra website project, built with Umbra itself.

## Backend Apps

The project was created with `umbra startproject --local` and the backend
areas were created with `umbra startapp --local`:
...
| `prebuilt_plugins` | Official Umbra plugin records and plugin-owned features |
...
| `showcase` | Websites and applications using Umbra |
