...
//! on Umbra. Visitors submit via the form; the admin moderates
...
/// A website or application built on Umbra. Public form lets
...
pub struct ShowcaseEntry {
    ...
    /// runs on Umbra. Public form leaves it false.
