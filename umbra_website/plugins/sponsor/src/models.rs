...
//!
//! [`Partner`] is an organisation or individual backing Umbra — shown on
...
/// A partner / sponsor backing Umbra. Public-facing on `/sponsor`, but
...
pub struct SponsorInquiry {
    ...
    #[umbra(widget = "markdown", help = "Tell us a bit about your goals.")]
    pub message: String,
