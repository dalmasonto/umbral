...
const CATALOG: &[Category] = &[
    ...
    Category {
        ...
        features: &[
            ...
            Feat { name: "OAuth / social login", summary: "Google/GitHub login + account connection (umbra-oauth).", status: SH, maturity: BETA },
            Feat { name: "CSRF, HSTS, headers", summary: "Secure-by-default protections via umbra-security.", status: SH, maturity: STA },
        ],
    },
    Category {
        name: "REST & API",
