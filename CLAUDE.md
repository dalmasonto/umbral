...
This project is indexed by GitNexus as **umbral** (23250 symbols, 51539 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
