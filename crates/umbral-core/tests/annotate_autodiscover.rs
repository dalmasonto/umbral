...
use umbral::orm::{Aggregate, ForeignKey};
use umbral_core::db;
...
#[derive(Debug, Clone, sqlx::FromRow, Serialize, Deserialize, umbral::orm::Model)]
#[umbral(table = "ad_book", soft_delete)]
pub struct Book {
    pub id: i64,
    pub title: String,
