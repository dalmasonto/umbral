...
//! a `choices` field whose `#[umbral(default = "...")]` isn't one of the
...
//!
//! See `crates/umbral-core/src/check.rs::field_choices_default`.

use std::collections::HashMap;

use umbral::check::{CheckLocation, Severity};
use umbral::{App, BuildError, Environment, Settings};
...
#[derive(
    Debug, Default, sqlx::FromRow, serde::Serialize, serde::Deserialize, umbral::orm::Model,
)]
#[umbral(table = "scd_bad_default")]
pub struct BadDefault {
    pub id: i64,
    pub body: String,
    #[umbral(choices, default = "Mood::Sad")]
    pub mood: Mood,
}
