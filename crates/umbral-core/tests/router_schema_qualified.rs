...
async fn schema_router_qualifies_table_references() {
    ...
    let table_ref = umbral_core::db::router::schema_qualified_table("sq_widget");
    ...
    let other = umbral_core::db::router::schema_qualified_table("sq_other");
