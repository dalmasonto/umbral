...
// GENERATED ALWAYS clause — umbral's migration engine emits the bare
// `tsvector` declaration and leaves the population to the user.
// =========================================================================

/// A `umbral::orm::TsVector`-typed column (Postgres tsvector).
...
// network columns above, the Rust binding is a plain `String` — umbral
...
impl<T> ForeignKeyCol<T> {
    ...
    /// parents (`umbral-permissions::Permission.codename`), Uuid for
