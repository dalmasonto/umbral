...
use umbra_core::db;
use umbra_core::signals::{clear_for_tests, subscribe};
...
async fn boot() {
    BOOT.get_or_init(|| async {
        ...
        let path = dir.join(format!("umbra_dyn_signals_{}.db", std::process::id()));
...
fn meta() -> umbra::migrate::ModelMeta {
