...
pub mod migrate {
    ...
    pub use umbral_core::migrate::{
        ...
        fk_effective_type, is_initialised, make, make_empty, make_empty_in, make_in,
        migrate_apps_into_pool, migrate_apps_into_pool_in, model_alias, model_meta_for_table,
