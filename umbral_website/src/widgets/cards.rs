    ...
    Widget {
        ...
        data: WidgetDataFn::new(|_user| async move {
            let pending = pd::Plugin::objects()
                ...
                .unwrap_or(0);
            WidgetPayload::Card(
                CardPayload::new(umbral_admin::humanize_number(pending as f64))
                    .unit("in queue")
                    .icon("clock")
    ...
    Widget {
        ...
        data: WidgetDataFn::new(|_user| async move {
            let featured = pd::Plugin::objects()
                ...
                .unwrap_or(0);
            WidgetPayload::Card(
                CardPayload::new(umbral_admin::humanize_number(featured as f64))
                    .unit("plugins")
                    .icon("star")
    ...
    Widget {
        ...
        data: WidgetDataFn::new(|_user| async move {
            ...
            WidgetPayload::Kpi(KpiPayload {
                value: umbral_admin::humanize_number(shipped as f64),
