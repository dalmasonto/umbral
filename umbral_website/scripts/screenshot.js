...
//
// The script logs in as the superuser (env UMBRAL_ADMIN_USER /
// UMBRAL_ADMIN_PASSWORD), captures /admin/, writes to
...
const BASE = process.env.UMBRAL_BASE_URL || 'http://127.0.0.1:8000';
const USER = process.env.UMBRAL_ADMIN_USER || 'admin';
const PASS = process.env.UMBRAL_ADMIN_PASSWORD || 'admin';
...
(async () => {
  ...
  try {
    ...
    console.error('[screen] Set UMBRAL_ADMIN_USER and UMBRAL_ADMIN_PASSWORD, or');
