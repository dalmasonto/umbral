...
//!
//! Honesty matters here: Umbral is greenfield, so we do NOT fabricate
//! third-party adopters. We seed only the framework's OWN properties that
//! are genuinely built with Umbral (dogfooding) — this website, the docs,
...
const REPO: &str = "https://github.com/dalmasonto/umbral";
...
const ENTRIES: &[Seed] = &[
    Seed {
        project_name: "Umbral Plugin Directory",
        url: "https://github.com/dalmasonto/umbral/tree/main/umbral_website",
        owner: "Umbral team",
        short_description: "The official umbral.dev site — a plugin directory, moderation admin, OAuth login, and REST API, all built on Umbral itself.",
    ...
    Seed {
        ...
        url: "https://github.com/dalmasonto/umbral/tree/main/examples/shop",
        owner: "Umbral team",
    ...
    Seed {
        project_name: "Umbral Documentation",
        url: "https://github.com/dalmasonto/umbral/tree/main/documentation",
        owner: "Umbral team",
