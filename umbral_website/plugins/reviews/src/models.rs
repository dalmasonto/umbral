...
//!
//! A `Review` is a developer review of the Umbral framework itself.
...
/// A single developer review of Umbral. One active review per
...
/// umbral_version, usage_context. Everything else is
/// `#[umbral(noform)]` and stamped by the admin / framework.
#[derive(Debug, Clone, sqlx::FromRow, Serialize, Deserialize, Model, umbral::forms::Form)]
#[umbral(soft_delete, plugin = "reviews", display = "Reviews", icon = "star")]
pub struct Review {
    pub id: i64,
    ...
    #[umbral(noform, on_delete = "cascade")]
    ...
    #[umbral(noform, choices, index, default = "pending")]
