//! Account and trust-gate models for the Umbral website.
//!
...
#[umbral(soft_delete, plugin = "accounts", display = "Website profiles", icon = "user")]
...
#[derive(Debug, Clone, sqlx::FromRow, Serialize, Deserialize, Model)]
#[umbral(soft_delete, plugin = "accounts", display = "GitHub accounts", icon = "github")]
...
#[derive(Debug, Clone, sqlx::FromRow, Serialize, Deserialize, Model)]
#[umbral(soft_delete, plugin = "accounts", display = "Trust gate checks", icon = "shield-check")]
